...
<body>
    ...
    <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
        <a class="navbar-brand brand-logo" href="{{ url('/admin/home') }}">
          <img src="{{ url('/assets/startadmin') }}/images/logo.svg" alt="logo" />
        </a>
        <a class="navbar-brand brand-logo-mini" href="{{ url('/admin/home') }}">
          <img src="{{ url('/assets/startadmin') }}/images/logo-mini.svg" alt="logo" />
        </a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="{{ url('/assets/startadmin') }}/images/faces/face4.jpg" alt="image" class="profile-pic">
                </div>
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="{{ url('/assets/startadmin') }}/images/faces/face2.jpg" alt="image" class="profile-pic">
                </div>
                <div class="preview-item-content flex-grow">
              ...
              <a class="dropdown-item preview-item">
                <div class="preview-thumbnail">
                  <img src="{{ url('/assets/startadmin') }}/images/faces/face3.jpg" alt="image" class="profile-pic">
                </div>
                <div class="preview-item-content flex-grow">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <!-- <img class="img-xs rounded-circle" src="{{ url('/assets/startadmin') }}/images/faces/face1.jpg" alt="Profile image"> -->
              @if(!empty(\Auth::user()->name))
              <img src="{{ Avatar::create(\Auth::user()->name)->setDimension(32)->setFontSize(14)->toBase64() }}" />
              @endif
            </a>
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                <div class="profile-image">
                  {{-- <img src="{{ url('/assets/startadmin') }}/images/faces/face1.jpg" alt="profile image"> --}}
                  @if(!empty(\Auth::user()->name))
                    <img src="{{ Avatar::create(\Auth::user()->name)->setDimension(64)->setFontSize(32)->toBase64() }}" />
                  @endif
                </div>
  ...
  <script src="{{ url('/assets/startadmin') }}/js/dashboard.js"></script>
  ...
  <script>
    $(".actionDelete").click(function() {
      ...
      c = confirm("Continue Delete data ?")
